package ese104; 
 ...
 public class Ese104 { 
 	...
 	public static void main(String[] args) throws Exception { 
 		...
 		Prenotazione p = new Prenotazione("p1", 2, presidente, montecitorio); 
 		caraibi.addPrenotazione(p); 
 		System.out.println("Aggiunta " + p); 
 		p = new Prenotazione("p2", 6, presidente, montecitorio); 
 		caraibi.addPrenotazione(p); 
 		System.out.println("Aggiunta " + p); 
 		try { 
 			p = new Prenotazione("p3", 3, presidente, montecitorio); 
 			caraibi.addPrenotazione(p); 
 			throw new Exception("Non è stata lanciata l'eccezione per posti non disponibili"); 
 		} 
 		catch (Exception e) { 
